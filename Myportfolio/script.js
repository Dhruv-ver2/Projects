...
function initAboutMeSection() {
    ...
    // NEW FUNCTION to handle image swapping
    function updateCardImages(themeName) {
        ...
        if (!cryptoCard || !portfolioCard || !hiddenVentureImg || !topSecretCard) return;
    ...
    function applyTheme(themeName) {
        ...
        updateCardImages(themeName); // CALL THE IMAGE SWAP FUNCTION HERE
