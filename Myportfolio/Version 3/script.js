...
function initAboutMeSection() {
    ...
    */
    ...
    function applyTheme(themeName) {
        // Synchronized class management across body and root
        ...
        // Swap images based on the current theme
        updateCardImages(themeName); 

        // Re-initialize dynamic animations with current theme colors
